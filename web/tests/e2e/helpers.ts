...
export const cell = (page: Page, index: number) => page.locator(`[data-cell-index="${index}"]`);
export const saved = (page: Page) => expect(page.getByTestId("save-status")).toHaveText("Saved");
export async function importText(
  page: Page,
  text: string,
  confirm = "Import as new draft",
): Promise<void> {
