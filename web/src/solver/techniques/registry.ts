...
const advanced=[...fishTechniques,...shortPatternTechniques,...wingTechniques,...bentSubsetTechniques,...remotePairTechniques,...coloringTechniques,...chainTechniques,...loopTechniques,...alsPatternTechniques,...deathBlossomTechniques,...sueDeCoqTechniques,...alignedExclusionTechniques];
