...
export interface CoverageEvidence {
  readonly kind: "positive" | "negative" | "boundary" | "original-clue" | "independent-oracle";
    ...
    [
      {
        id: "C01",
        version: "c01@1",
        aliases: ["Naked Single", "Full House", "Last Digit"],
        tier: 0,
        capabilities: ["D", "A"],
        assumptionPolicy: "unconditional",
        bounds:
          "Singleton unresolved domain; Full House is a one-empty covering house presentation. One placement plus explicit peer removals.",
      ...
      },
      {
        ...
        assumptionPolicy: "unconditional",
        bounds:
          "One remaining support in a proved symbol cover; all 27 classic houses and nine symbols.",
        grammarId: "c02-grammar@1",
        detectorId: "c02@1",
        checkerId: "c02-grammar@1",
        descriptionPath: "docs/solver/techniques/foundation.md",
        fixtureIds: ["C02-box", "C02-column", "C02-row", "C02-small-cage-negative"],
        status: "independently-verified",
        evidence: [
          {
            kind: "positive",
      ...
      },
      {
        id: "C03",
        version: "c03@1",
        aliases: ["Locked Candidates", "pointing", "claiming", "direct forms"],
        tier: 0,
        capabilities: ["D", "A", "H"],
        assumptionPolicy: "unconditional",
        bounds:
          "Nonempty proper intersection of a cover and all-different group; supports confined to intersection, remove outside. Classic both box→line and line→box, support size 2–3; singleton reported C02. Direct-single consequence is a subsequent C01/C02 step.",
      ...
      },
      {
        ...
        tier: 1,
        capabilities: ["D", "A; hidden also H"],
        assumptionPolicy: "unconditional",
        bounds:
          "n=2…4 direct enumeration; complementary house forms n=5…7 recognized through the n=4…2 complement with explicit alias metadata, not separate discovery. Naked union size n; hidden complete supports in n cells.",
      ...
      },
      {
        id: "C05",
        version: "c05@1",
        aliases: ["Locked Pair", "Locked Triple"],
        tier: 1,
        capabilities: ["D", "A", "H"],
        assumptionPolicy: "unconditional",
        bounds:
          "C04 n=2…3 entirely within a box-line intersection, with separate proved effects in each applicable house; combine only roots already checked.",
      ...
      },
      {
        id: "C06",
        version: "c06@1",
        aliases: ["X-Wing", "Swordfish", "Jellyfish", "Squirmbag", "Whale", "Leviathan"],
        tier: 2,
        capabilities: ["D", "A", "H", "K"],
        assumptionPolicy: "unconditional",
        bounds:
          "n=2…7 disjoint parallel base lines and n orthogonal cover lines, one symbol. Supports of every base contained in covers; remove from covers outside bases. Both orientations, all support densities including smaller equivalent fish.",
        ...
        evidence: [
          {
            ...
            alias: "X-Wing",
            record:
              "web/tests/unit/solver/fish-complex.test.ts#actual discovery proves the required named bound class",
          },
          {
            kind: "negative",
            fixtureId: "C06-size-2-row",
            alias: "X-Wing",
            record:
              "web/tests/unit/solver/fish.test.ts#rejects changed incidence, aliases, fins, size and complete-source premises",
          },
          {
            kind: "boundary",
            fixtureId: "C06-size-2-row",
            alias: "X-Wing",
            record:
              "web/tests/unit/solver/fish.test.ts#independently rejects the documented negative/profile shape",
          },
          {
            kind: "original-clue",
            fixtureId: "C06-size-2-row",
            alias: "X-Wing",
            record:
              "web/tests/unit/solver/fish-complex.test.ts#replays its independent certificate from original clues",
          },
          {
            kind: "independent-oracle",
            fixtureId: "C06-size-2-row",
            alias: "X-Wing",
            record:
              "web/tests/unit/solver/fish-complex.test.ts#all 63 unchanged original inputs reproduce hashes, SAT and 98 forced counterfactuals",
          },
          {
            kind: "positive",
      ...
      },
      {
        id: "C07",
        version: "c07@1",
        aliases: ["Finned fish", "Sashimi fish"],
        tier: 4,
        capabilities: ["D", "A", "H", "K"],
        assumptionPolicy: "discharged",
        bounds:
          "Basic n=2…7, 1…4 exo-fin candidate occurrences confined to one box. Under target=true all fins conflict and finless cover argument follows. Sashimi permits missing corners and <2 residual supports; exact incidence proof required.",
      ...
      },
      {
        id: "C08",
        version: "c08@1",
        aliases: ["Franken fish", "Mutant fish"],
        tier: 4,
        capabilities: ["D", "A", "H", "K"],
        assumptionPolicy: "discharged",
        bounds:
          "n=2…4, any distinct classic base/cover house sets. Franken mixes boxes with one line orientation per side; Mutant permits row/column/box mixing. <=4 fin occurrences. Overlaps handled by the incidence certificate below.",
      ...
      },
      {
        id: "C09",
        version: "c09@1",
        aliases: ["Endo-fin fish", "Cannibalistic fish", "Siamese fish"],
        tier: 4,
        capabilities: ["D", "A", "H", "K"],
        assumptionPolicy: "discharged",
        bounds:
          "C08 sizes 2…4; <=4 combined endo/exo-fin occurrences; cannibalistic target may lie in a base. Siamese is exactly two same-symbol fish sharing the base set with different covers, each separately checked (union of effects, no unsupported synergistic claim).",
        ...
        evidence: [
          {
            ...
            alias: "Turbot Fish",
            record:
              "web/tests/unit/solver/short-patterns.test.ts#independent named evidence and productive discovery",
          },
          {
            kind: "negative",
            fixtureId: "C10-turbot",
            alias: "Turbot Fish",
            record:
              "web/tests/unit/solver/wings.test.ts#rejects primitive mutations and replays the original clue prefix",
          },
          {
            kind: "boundary",
            fixtureId: "C10-turbot",
            alias: "Turbot Fish",
            record:
              "web/tests/unit/solver/wings.test.ts#enforces its named alias and exact tuple/path boundary",
          },
          {
            kind: "original-clue",
            fixtureId: "C10-turbot",
          ...
          },
          {
            ...
            alias: "Turbot Fish",
            record:
              "web/tests/unit/solver/wings.test.ts#durable seed hashes reproduce SAT and both forced and forbidden counterfactuals independently",
          },
          {
            kind: "positive",
      ...
      },
      {
        id: "C11",
        version: "c11@1",
        aliases: ["XY-Wing", "Y-Wing", "XYZ-Wing", "W-Wing"],
        tier: 2,
        capabilities: ["D", "A", "G"],
        assumptionPolicy: "unconditional",
        bounds:
          "XY: three bivalue cells, pivot XY, wings XZ/YZ seeing pivot, target sees both Z wings. XYZ: pivot XYZ and wings XZ/YZ, target sees all Z occurrences. W: two identical bivalue endpoints plus a conjugate-house bridge on one endpoint symbol.",
        ...
        evidence: [
          {
            ...
            alias: "XY-Wing",
            record:
              "web/tests/unit/solver/wings.test.ts#independent named evidence and productive discovery",
          },
          {
            kind: "negative",
            fixtureId: "C11-xy-box",
      ...
      },
      {
        id: "C12",
        version: "c12@1",
        aliases: ["WXYZ-Wing", "Bent almost-locked subsets"],
        tier: 4,
        capabilities: ["D", "A", "R"],
        assumptionPolicy: "discharged",
        bounds:
          "n=4…6 cells with n symbols; one nonrestricted common symbol z, every other shared symbol restricted across non-seeing portions. Enumerate the selected n-cell assignments using only cited conflict edges and domains; all surviving assignments contain z in the pattern. Remove z only from targets seeing every possible z occurrence. No uniqueness premise.",
        ...
        evidence: [
          ...
          },
          {
            ...
            alias: "Bent almost-locked subsets",
            record:
              "web/tests/unit/solver/wings.test.ts#C12 partitions a 5000-assignment original-clue local table and checks all 220 survivors",
          },
          {
            kind: "negative",
            fixtureId: "C12-partition-n6",
            alias: "Bent almost-locked subsets",
            record:
              "web/tests/unit/solver/wings.test.ts#both Dual Empty Rectangle roots and every C12 table boundary remain necessary",
          },
          {
            kind: "boundary",
            fixtureId: "C12-partition-n6",
      ...
      },
      {
        id: "C13",
        version: "c13@1",
        aliases: ["Remote Pairs", "Chute Remote Pairs"],
        tier: 2,
        capabilities: ["D", "A", "G", "K"],
        assumptionPolicy: "unconditional",
        bounds:
          "Simple path of m=4/6/8/10/12 identical-bivalue cells; 2m-1 explicit inference links (internal cell strong edges included), <=24. Opposite endpoint colors; target conflicts with both endpoints for the same symbol. Target-conflict premises are additional. Chute requires all path cells in one band/stack (D074).",
      ...
      },
      {
        id: "C14",
        version: "c14@1",
        aliases: ["Simple coloring", "Color trap", "Color wrap", "Multi-coloring"],
        tier: 3,
        capabilities: ["D", "A", "H", "G"],
        assumptionPolicy: "discharged",
        bounds:
          "Single-symbol conjugate components over <=81 occurrences; trap target sees both colors, wrap same color contains conflict. Multi-color uses two components, exhaustive two-color assignments and checked cross-conflicts; <=4 color branches.",
        grammarId: "c14-grammar@1",
        detectorId: "c14@1",
        checkerId: "c14-grammar@1",
        descriptionPath: "docs/solver/techniques/chains-and-coloring.md",
        fixtureIds: ["C14-trap", "C14-wrap", "C14-multi"],
        status: "independently-verified",
        evidence: [
          {
            kind: "positive",
            ...
            record:
              "web/tests/unit/solver/coloring.test.ts#Simple coloring is a checked presentation of the exact trap component",
          },
          {
            kind: "negative",
            fixtureId: "C14-trap",
            alias: "Simple coloring",
            record:
              "web/tests/unit/solver/coloring.test.ts#requires complete edges XOR and every branch proof",
          },
          {
            kind: "boundary",
            fixtureId: "C14-trap",
          ...
          },
          {
            ...
            alias: "Simple coloring",
            record:
              "web/tests/unit/solver/chains.test.ts#replays from original clues with no assumed candidate axioms",
          },
          {
            kind: "independent-oracle",
            fixtureId: "C14-trap",
            alias: "Simple coloring",
            record:
              "web/tests/unit/solver/chains.test.ts#durable original seed hashes reproduce every satisfiable prestate and force-or-forbid counterfactual",
          },
          {
            kind: "positive",
            fixtureId: "C14-trap",
            alias: "Color trap",
            record:
              "web/tests/unit/solver/coloring.test.ts#has independent complete XOR evidence and oracle acceptance",
          },
          {
            kind: "negative",
            fixtureId: "C14-trap",
      ...
      },
      {
        ...
        assumptionPolicy: "discharged",
        bounds:
          "Components over <=729 cell-symbol literals using cell bivalue and house conjugate XOR edges; exhaustive 2-color alternatives with same-cell/house conflicts and common effects. Every edge checked, graph size remains bounded by actual candidates.",
        grammarId: "c15-grammar@1",
        detectorId: "c15@1",
        checkerId: "c15-grammar@1",
        descriptionPath: "docs/solver/techniques/chains-and-coloring.md",
        fixtureIds: ["C15-trap", "C15-house-wrap", "C15-cell-wrap"],
        status: "independently-verified",
        evidence: [
          {
            kind: "positive",
      ...
      },
      {
        id: "C16",
        version: "c16@1",
        aliases: ["X-Chains", "XY-Chains", "AICs"],
        tier: 4,
        capabilities: ["D", "A", "H", "G"],
        assumptionPolicy: "discharged",
        bounds:
          "Simple alternating weak/strong paths <=24 links; X uses one symbol, XY uses bivalue cell transitions, AIC permits both cell/house links. Endpoint inference via resolution or discharged target contradiction. Distinct path nodes except closing endpoint.",
        grammarId: "c16-grammar@1",
        detectorId: "c16@1",
        checkerId: "c16-grammar@1",
        descriptionPath: "docs/solver/techniques/chains-and-coloring.md",
        fixtureIds: ["C16-xy-24-vertices", "C16-x-4-vertices", "C16-aic-cell-and-house"],
        status: "independently-verified",
        evidence: [
          {
            kind: "positive",
            ...
            alias: "X-Chains",
            record:
              "web/tests/unit/solver/chains.test.ts#has independent exact named evidence and force/forbid acceptance",
          },
          {
            kind: "negative",
            fixtureId: "C16-x-4-vertices",
            alias: "X-Chains",
            record:
              "web/tests/unit/solver/chains.test.ts#rejects alias source assumption and count corruption",
          },
          {
            kind: "boundary",
            fixtureId: "C16-x-4-vertices",
            alias: "X-Chains",
            record:
              "web/tests/unit/solver/chains.test.ts#also compiles through production at the exact independently authored geometry",
          },
          {
            kind: "original-clue",
            fixtureId: "C16-x-4-vertices",
      ...
      },
      {
        ...
        tier: 4,
        capabilities: ["D", "A", "H", "G", "R"],
        assumptionPolicy: "discharged",
        bounds:
          "<=24 links; at most four group/ALS nodes per path, groups <=3 same-symbol occurrences, ALS <=5 cells. Continuous loop weak edges become strong through complete cyclic proof; discontinuity uses the checked repeated endpoint to infer its polarity.",
      ...
      },
      {
        id: "C18",
        version: "c18@1",
        aliases: ["ALS-XZ", "ALS-XY-Wing"],
        tier: 4,
        capabilities: ["D", "A", "R"],
        assumptionPolicy: "unconditional",
        bounds:
          "Two/three ALSs each 1…5 cells. Support disjoint and overlapping sets only with overlap excluded from RCC and a checked table/cover argument; one or two RCCs, all cross-occurrences conflict. XZ uses two sets, XY-Wing three; eliminate only from targets seeing all relevant z occurrences.",
        ...
        evidence: [
          {
            ...
            alias: "ALS-XZ",
            record:
              "web/tests/unit/solver/als-patterns.test.ts#independent named proof and exhaustive counterfactual evidence",
          },
          {
            kind: "negative",
            fixtureId: "C18-overlap",
          ...
          },
          {
            ...
            alias: "ALS-XZ",
            record:
              "web/tests/unit/solver/als-patterns.test.ts#all advertised ALS and stem bounds have explicit authored geometry",
          },
          {
            kind: "original-clue",
            fixtureId: "C18-overlap",
            alias: "ALS-XZ",
            record:
              "web/tests/unit/solver/als-patterns.test.ts#replays original clues and declared rules",
          },
          {
            kind: "independent-oracle",
            fixtureId: "C18-overlap",
            alias: "ALS-XZ",
            record:
              "web/tests/unit/solver/als-patterns.test.ts#durable input hashes reproduce every satisfiable prestate and exhaustive opposite",
          },
          {
            kind: "positive",
            fixtureId: "C18-xy",
      ...
      },
      {
        id: "C19",
        version: "c19@1",
        aliases: ["ALS chains", "Death Blossom"],
        tier: 4,
        capabilities: ["D", "A", "R", "G"],
        assumptionPolicy: "discharged",
        bounds:
          "ALS chain <=6 sets and <=24 links, each <=5 cells; Death Blossom one stem of 2…4 candidates with one petal per candidate, all stem alternatives covered, petals <=5 cells. Proof may share petals but cannot ignore overlap conflicts.",
      ...
      },
      {
        id: "C20",
        version: "c20@1",
        aliases: ["Sue de Coq", "Two-sector disjoint subsets"],
        tier: 5,
        capabilities: ["D", "A", "H", "R", "K"],
        assumptionPolicy: "unconditional",
        bounds:
          "Box-line intersection of 2…3 cells, plus disjoint side ALSs of 1…4 cells each outside intersection in line/box; total <=11 cells, <=9 symbols. Reconstruct allowed symbol allocations with Hall/cover counts; only proved side/intersection eliminations.",
        ...
        evidence: [
          {
            ...
            alias: "Sue de Coq",
            record:
              "Independent named certificate and exact production compilation; both C20 spellings checked.",
          },
          {
            kind: "negative",
            fixtureId: "C20-intersection-2",
            alias: "Sue de Coq",
            record:
              "Named geometry/domain/tuple/capacity mutations plus standalone and mixed primitive-valid substitute-root rejection.",
          },
          {
            kind: "boundary",
            ...
            alias: "Sue de Coq",
            record:
              "Exact finite scope certificate; 256-leaf partition completeness; Cartesian6561 and occupancy4096 gates in set-arguments.test.ts.",
          },
          {
            kind: "original-clue",
            fixtureId: "C20-intersection-2",
            alias: "Sue de Coq",
            record:
              "Independent original-given prefix replay; max11 includes17 C01 placements and1 C04 naked pair; no candidate axioms.",
          },
          {
            kind: "independent-oracle",
            fixtureId: "C20-intersection-2",
            alias: "Sue de Coq",
            record:
              "Independent Algorithm X: satisfiable pre-state, exhausted forced removal and satisfiable forbid; npm test -- tests/unit/solver/set-arguments.test.ts.",
          },
          {
            kind: "positive",
            fixtureId: "C20-intersection-2",
      ...
      },
      {
        id: "C22",
        version: "c22@1",
        aliases: ["Digit forcing chains", "Cell forcing chains", "Unit forcing chains", "Nishio"],
        tier: 6,
        capabilities: ["D", "A", "H", "G"],
        assumptionPolicy: "discharged",
        bounds:
          "Candidate true/false split; all 2…9 cell alternatives; all 2…9 house-symbol supports. <=24 links per branch. Nishio is one digit, one target=true, only single-digit cover/weak-link consequences until contradiction.",
      ...
      },
      {
        id: "C23",
        version: "c23@1",
        aliases: ["Static forcing nets", "Dynamic forcing nets", "Nested forcing"],
        tier: 6,
        capabilities: ["D", "A", "H", "G", "R"],
        assumptionPolicy: "discharged",
        bounds:
          "<=128 inference nodes/branch, <=9 alternatives, nesting depth <=2, <=81 cells. Static uses original graph; dynamic rebuilds links only from proved branch domains. Nested branches use C01–C05 propagation and graph resolution only; no recursive whole-solver calls or MRV DFS.",
      ...
      },
      {
        ...
        assumptionPolicy: "discharged",
        bounds:
          "C07/C08 fish size 2…4, <=4 fins; instead of direct target/fin visibility, prove target=true forces every fin false via <=24-link branches. Apply underlying checked fish certificate.",
      ...
      },
      {
        id: "C25",
        version: "c25@1",
        aliases: ["Bivalue chains", "z-chains"],
        tier: 6,
        capabilities: ["D", "A", "H", "G"],
        assumptionPolicy: "discharged",
        bounds:
          "<=12 pairs. Bivalue pairs have exactly two original alternatives. z-pairs may exclude extra alternatives by conflict with Z only; endpoint closes through Z. Bivalue-chain endpoint presentation may instead eliminate a target seeing both chain endpoints.",
        ...
        evidence: [
          ...
          },
          {
            ...
            record:
              "web/tests/unit/solver/generalized-chains.test.ts#C25-bivalue-12-no-premature-close",
          },
          {
            kind: "original-clue",
            fixtureId: "C25-bivalue-12-no-premature-close",
          ...
          },
          {
            ...
            alias: "Bivalue chains",
            record:
              "web/tests/unit/solver/generalized-chains.test.ts#C25-bivalue-13-no-premature-close",
          },
          {
            kind: "negative",
            fixtureId: "C25-bivalue-13-no-premature-close",
      ...
      },
      {
        id: "C26",
        version: "c26@1",
        aliases: ["t-whips", "Whips"],
        tier: 6,
        capabilities: ["D", "A", "H", "G"],
        assumptionPolicy: "discharged",
        bounds:
          "<=12 pairs. t-pairs exclude extras through earlier right candidates only; whips permit Z and earlier right candidates. Continuous Li→previous Ri is required; final no-right variable must list every eliminated alternative with its allowed conflict witness.",
      ...
      },
      {
        id: "C27",
        version: "c27@1",
        aliases: ["Braids", "g-whips"],
        tier: 6,
        capabilities: ["D", "A", "H", "G"],
        assumptionPolicy: "discharged",
        bounds:
          "Braid <=12 pairs relaxes Li predecessor to Z or any earlier Ri, while each right is the sole survivor relative to Z/earlier rights. g-whip remains continuous, but <=4 right groups of <=3 occurrences may replace scalar rights; every conflict against a group holds for all members.",
      ...
      },
      {
        ...
        evidence: [
          ...
          },
          {
            ...
            alias: "OR-k forcing",
            record:
              "web/tests/unit/solver/generalized-chains.test.ts#C28-generalized-C27-braid-causal",
          },
          {
            kind: "original-clue",
            fixtureId: "C28-generalized-C27-braid-causal",
          ...
          },
          {
            ...
            alias: "OR-k forcing",
            record:
              "web/tests/unit/solver/generalized-chains.test.ts#C28-generalized-C27-braid-causal-12",
          },
          {
            kind: "original-clue",
            fixtureId: "C28-generalized-C27-braid-causal-12",
          ...
          },
          {
            ...
            alias: "OR-k forcing",
            record:
              "web/tests/unit/solver/generalized-chains.test.ts#C28-generalized-C27-gwhip-group2",
          },
          {
            kind: "original-clue",
            fixtureId: "C28-generalized-C27-gwhip-group2",
          ...
          },
          {
            ...
            alias: "OR-k forcing",
            record:
              "web/tests/unit/solver/generalized-chains.test.ts#C28-generalized-C27-gwhip-members3",
          },
          {
            kind: "original-clue",
            fixtureId: "C28-generalized-C27-gwhip-members3",
          ...
          },
          {
            ...
            alias: "OR-k forcing",
            record:
              "web/tests/unit/solver/generalized-chains.test.ts#C28-generalized-C27-gwhip-groups4",
          },
          {
            kind: "original-clue",
            fixtureId: "C28-generalized-C27-gwhip-groups4",
          ...
          },
          {
            ...
            alias: "OR-k whips",
            record:
              "web/tests/unit/solver/generalized-chains.test.ts#C28-inserted-or2-thirteen-sound",
          },
          {
            kind: "negative",
            fixtureId: "C28-inserted-or2-thirteen-sound",
      ...
      },
      {
        id: "C33",
        version: "c33@1",
        aliases: ["Per-digit templates", "Pattern overlay", "POM", "Template incompatibility"],
        tier: 5,
        capabilities: ["D", "A", "H", "K", "R"],
        assumptionPolicy: "unconditional",
        bounds:
      ...
      },
      {
        ...
        tier: 6,
        capabilities: ["K", "U", "D", "H"],
        assumptionPolicy: "unique-only",
        bounds:
          "Four cells in two rows/two columns/two boxes, two core symbols, empty of original givens. Each type's eliminations must reduce the forbidden core-only swap situation through a checked subset/strong-link/case proof, <=24 links. Validate type annotation separately from uniqueness-transform.",
      ...
      },
      {
        id: "U02",
        version: "u02@1",
        aliases: ["Hidden Rectangle", "Avoidable Rectangle", "Extended Rectangle"],
        tier: 6,
        capabilities: ["K", "U", "D", "H"],
        assumptionPolicy: "unique-only",
        bounds:
          "Hidden uses same 2×2 geometry plus certified strong links. Avoidable allows derived assignments but never changed givens and includes all assignment provenance. Extended supports 2×3 or 3×2 six-cell rectangles, <=3 core symbols, explicit nonidentity permutation preserving every affected house and clue.",
      ...
      },
      {
        id: "U03",
        version: "u03@1",
        aliases: ["Unique Loops"],
        tier: 6,
        capabilities: ["K", "U", "D", "H"],
        assumptionPolicy: "unique-only",
        bounds:
          "Even loop of 4…12 cells, two core symbols, each affected house contains zero or two loop cells; no original given changed. <=4 extra guardian literals; core alternation enables a nontrivial preserved assignment swap.",
      ...
      },
      {
        id: "U05",
        version: "u05@1",
        aliases: ["Generalized BUG", "BUG+n"],
        tier: 6,
        capabilities: ["K", "U", "D", "H"],
        assumptionPolicy: "unique-only",
        bounds:
          "n=2…4 extra candidate occurrences over a checked U04 core; derive OR of every extra, then direct common conflict or <=24-link conditional forcing consequences. No arbitrary multivalue residual labeled BUG.",
...
export function validateCoverage(entries: readonly CoverageEntry[]): readonly string[] {
  ...
  for (const entry of entries) {
    ...
    if (
      ...
      entry.aliases.some((alias) => !known.aliases.includes(alias))
    )
      errors.add("unknown-alias");
    if (
      known &&
      (entry.bounds !== known.bounds ||
        entry.version !== known.version ||
        entry.grammarId !== known.grammarId ||
        entry.detectorId !== known.detectorId ||
        entry.checkerId !== known.checkerId ||
        entry.tier !== known.tier ||
        entry.assumptionPolicy !== known.assumptionPolicy ||
        JSON.stringify(entry.capabilities) !== JSON.stringify(known.capabilities))
    )
      errors.add("changed-profile-contract");
...
export const aliasMappings = Object.freeze(
  coverageEntries.flatMap((entry) =>
...
export const unsupportedAliases = Object.freeze(
  [
    {
      alias: "Unlimited whips/braids",
      reason: "Generalized paths exceed 12 pairs",
      nearestSupportedForm: "C25–C27 bounded generalized chains",
    },
    {
      alias: "Unlimited chains and nets",
      reason: "Chains exceed 24 links or forcing depth exceeds two",
      nearestSupportedForm: "C16–C17 / C22–C23",
    },
    {
      alias: "Fish above size seven",
      reason: "Basic fish supports sizes 2–7",
      nearestSupportedForm: "C06 Leviathan",
    },
    {
      alias: "Complex fish above size four",
      reason: "Complex incidence grammar supports sizes 2–4",
      nearestSupportedForm: "C08–C09",
    },
    {
      alias: "Fish with more than four fins",
      reason: "Combined fin occurrence cap is four",
      nearestSupportedForm: "C07–C09 / C24",
    },
    {
      alias: "ALS above five cells",
      reason: "Per-ALS bound is five cells",
      nearestSupportedForm: "C18–C19",
    },
    {
      alias: "Aligned exclusion above four selected cells",
      reason: "Cartesian selected scope is bounded at four",
      nearestSupportedForm: "C21",
    },
    {
      alias: "General non-Junior Exocet",
      reason: "No specified transformation/cover grammar outside Junior geometry",
      nearestSupportedForm: "C31 Junior Exocet",
    },
    {
      alias: "Unproved Exocet mirror or escape",
      reason: "Visual naming does not establish a cover theorem",
      nearestSupportedForm: "C31 checked base-target relations",
    },
    {
      alias: "Non-ring generalized SK patterns",
      reason: "Only the eight-group four-box ring is specified",
      nearestSupportedForm: "C30 SK Loops",
    },
    {
      alias: "Other Tridagon geometries",
      reason: "Only the four-box twelve-cell schema is specified",
      nearestSupportedForm: "C32",
    },
    {
      alias: "Nine-symbol overlay search",
      reason: "POM supports bounded two/three-symbol overlays",
      nearestSupportedForm: "C33",
    },
    {
      alias: "BUG with more than four extras",
      reason: "Conditional extras are bounded at four",
      nearestSupportedForm: "U05",
    },
    {
      alias: "Custom variants",
      reason: "M2 production registration is classic only",
      nearestSupportedForm: "Classic rule profile",
    },
    {
      alias: "Bowman's Bingo / unrestricted trial and error",
      reason: "Unrestricted DFS is fallback search, not a named logical grammar",
      nearestSupportedForm: "Explicit exact fallback",
    },
