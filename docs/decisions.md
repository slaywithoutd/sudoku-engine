...
- Review refinement: closed conditional source facts remain available to C33; open assumptions remain excluded. Primitive tests cover inherited taint, scopes and rule provenance. Actual uniqueness-derived placement through C33 compilation, discovery, checking, conditional commit and original replay is an explicit T18/T25 integration gate, including primary admission and Perfect refusal. No synthetic source issuer substitutes for that gate.
