...
| T11 Coloring, chains and loops | In progress | Sixteen independent original-clue seeds prepared; implementation dispatch follows the T10 documentation checkpoint. |
| T12-T27 | Pending | Approved requirements remain in the implementation plan; no family dropped. |
