...
| `weak-link@1`, `cover-clause@1` | Same-cell exclusion or all-different/declared relation conflict; exhaustive alternatives from a proved cover/domain. |
