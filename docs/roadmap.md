...
T01-T11 are implemented and independently reviewed, covering C01-C17. Fish commit `43fc459` passed 853 tests and typecheck; two minor fixture/provenance follow-ups are assigned to the T25 integration gate. T11 coloring/chains/loops passed 967 tests before review fix `ed7ea09`; final 92 affected tests, typecheck and scoped re-review passed. ALS relationships and Death Blossom are next. Later families, worker/application integration and resource calibration remain required before M2 becomes available.
